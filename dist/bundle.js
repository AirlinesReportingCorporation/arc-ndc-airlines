    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 55, 8, 1817);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			if (if_block) if_block.c();
    			attr_dev(div0, "class", "air-designator svelte-168fcde");
    			add_location(div0, file$1, 27, 14, 814);
    			attr_dev(div1, "class", "air-code svelte-168fcde");
    			add_location(div1, file$1, 28, 14, 883);
    			attr_dev(div2, "class", "d-flex align-items-center");
    			add_location(div2, file$1, 26, 12, 760);
    			attr_dev(div3, "class", "air-name svelte-168fcde");
    			add_location(div3, file$1, 34, 12, 1117);
    			attr_dev(span, "class", "svelte-168fcde");
    			add_location(span, file$1, 37, 16, 1314);
    			attr_dev(div4, "class", "air-updated svelte-168fcde");
    			set_style(div4, "margin-right", "0px");
    			add_location(div4, file$1, 36, 14, 1245);
    			attr_dev(div5, "class", "ml-auto d-flex align-items-center");
    			add_location(div5, file$1, 35, 12, 1183);
    			attr_dev(div6, "class", "d-flex flex-column flex-lg-row");
    			add_location(div6, file$1, 25, 10, 703);
    			attr_dev(div7, "class", "col-11");
    			add_location(div7, file$1, 24, 8, 672);

    			attr_dev(div8, "class", div8_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2]
    			? "active open expand"
    			: "closed expand") + " svelte-168fcde"));

    			attr_dev(div8, "aria-expanded", /*isOpen*/ ctx[2]);
    			add_location(div8, file$1, 45, 10, 1543);
    			attr_dev(div9, "class", "col-1 svelte-168fcde");
    			add_location(div9, file$1, 43, 8, 1446);
    			...
    			add_location(div10, file$1, 19, 6, 532);
    			attr_dev(div11, "class", "product-accordion-start svelte-168fcde");
    			add_location(div11, file$1, 18, 4, 488);
    			attr_dev(div12, "class", "product-accordion-top svelte-168fcde");
    			add_location(div12, file$1, 17, 2, 448);

    			attr_dev(div13, "class", div13_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2]
    			? "active airline-accordion product-accordion-row"
    			: "airline-accordion product-accordion-row") + " svelte-168fcde"));

    			add_location(div13, file$1, 12, 0, 319);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
