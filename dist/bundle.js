...
var app = (function () {
    ...
    */
    ...
    /* node_modules/svelte-fa/src/fa.svelte generated by Svelte v3.53.1 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g0, file$3, 81, 6, 1397);
    			...
    			add_location(g1, file$3, 77, 4, 1293);
    			...
    			add_location(svg, file$3, 66, 2, 1071);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$3, 90, 10, 1678);
    			...
    			add_location(path1, file$3, 96, 10, 1935);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$3, 83, 10, 1461);
    		},
    		m: function mount(target, anchor) {
    ...
    // (33:8) {#each buttons as button}
    function create_each_block$1(ctx) {
    	let div;
    	let t_value = /*button*/ ctx[6].item + "";
    	let t;
    	let div_class_value;
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", div_class_value = /*button*/ ctx[6].itemClass);
    			add_location(div, file$2, 33, 10, 903);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*buttons*/ 8 && t_value !== (t_value = /*button*/ ctx[6].item + "")) set_data_dev(t, t_value);

    			if (dirty & /*buttons*/ 8 && div_class_value !== (div_class_value = /*button*/ ctx[6].itemClass)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:8) {#each buttons as button}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(h3, "margin-right", "15px");
    			add_location(h3, file$2, 13, 8, 338);
    			if (!src_url_equal(img.src, img_src_value = "https://www2.arccorp.com/globalassets/about-us/our-data/redesign/tooltip.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Help");
    			add_location(img, file$2, 16, 12, 464);
    			attr_dev(div0, "class", "airlineTooltipText");
    			add_location(div0, file$2, 20, 12, 618);
    			attr_dev(div1, "class", "airlineTooltip");
    			add_location(div1, file$2, 15, 10, 423);
    			attr_dev(div2, "class", "ml-auto");
    			add_location(div2, file$2, 14, 8, 391);
    			attr_dev(div3, "class", "d-flex align-items-center");
    			add_location(div3, file$2, 12, 6, 290);
    			attr_dev(div4, "class", "apSectionTop");
    			add_location(div4, file$2, 11, 4, 257);
    			attr_dev(div5, "class", /*bottomClass*/ ctx[2]);
    			attr_dev(div5, "style", /*bottomStyle*/ ctx[4]);
    			add_location(div5, file$2, 28, 6, 790);
    			attr_dev(div6, "class", "apSectionBottom");
    			add_location(div6, file$2, 27, 4, 754);
    			attr_dev(div7, "class", "apSection apSectionMarginLeft product-accordion-pb");
    			add_location(div7, file$2, 10, 2, 188);
    			attr_dev(div8, "class", div8_class_value = "col-lg-" + /*col*/ ctx[0]);
    			add_location(div8, file$2, 9, 0, 159);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*tooltip*/ 32) set_data_dev(t3, /*tooltip*/ ctx[5]);
    			...
    			if (dirty & /*bottomClass*/ 4) {
    				attr_dev(div5, "class", /*bottomClass*/ ctx[2]);
    			}

    			if (dirty & /*bottomStyle*/ 16) {
    				attr_dev(div5, "style", /*bottomStyle*/ ctx[4]);
    			}

    			if (dirty & /*col*/ 1 && div8_class_value !== (div8_class_value = "col-lg-" + /*col*/ ctx[0])) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { buttons = [] } = $$props;
    	let { bottomStyle } = $$props;
    	let { tooltip } = $$props;

    	$$self.$$.on_mount.push(function () {
    		if (col === undefined && !('col' in $$props || $$self.$$.bound[$$self.$$.props['col']])) {
    			console.warn("<Card> was created without expected prop 'col'");
    		}
    		...
    		if (bottomClass === undefined && !('bottomClass' in $$props || $$self.$$.bound[$$self.$$.props['bottomClass']])) {
    			console.warn("<Card> was created without expected prop 'bottomClass'");
    		}

    		if (bottomStyle === undefined && !('bottomStyle' in $$props || $$self.$$.bound[$$self.$$.props['bottomStyle']])) {
    			console.warn("<Card> was created without expected prop 'bottomStyle'");
    		}

    		if (tooltip === undefined && !('tooltip' in $$props || $$self.$$.bound[$$self.$$.props['tooltip']])) {
    			console.warn("<Card> was created without expected prop 'tooltip'");
    		}
    	});

    	const writable_props = ['col', 'title', 'bottomClass', 'buttons', 'bottomStyle', 'tooltip'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('bottomClass' in $$props) $$invalidate(2, bottomClass = $$props.bottomClass);
    		if ('buttons' in $$props) $$invalidate(3, buttons = $$props.buttons);
    		if ('bottomStyle' in $$props) $$invalidate(4, bottomStyle = $$props.bottomStyle);
    	...
    	return [col, title, bottomClass, buttons, bottomStyle, tooltip];
    }
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t0 = text("via ");
    			t1 = text(/*airName2*/ ctx[4]);
    			attr_dev(div, "class", "air-name-sub svelte-dafaow");
    			add_location(div, file$1, 73, 18, 2387);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*airName2*/ 16) set_data_dev(t1, /*airName2*/ ctx[4]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(73:16) {#if airName2.length > 0}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	card0 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: /*airline*/ ctx[0]["System Provider"].toString().length < 4
    						? "0" + /*airline*/ ctx[0]["System Provider"].toString()
    						: /*airline*/ ctx[0]["System Provider"]
    					}
    				],
    	...
    	card1 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: /*sfType*/ ctx[8][0],
    						itemClass: /*sfType*/ ctx[8][0] == /*airline*/ ctx[0]["Sales File Type"]
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: /*sfType*/ ctx[8][1],
    						itemClass: /*sfType*/ ctx[8][1] == /*airline*/ ctx[0]["Sales File Type"]
    						? "on apButton"
    						: "apButton"
    					}
    				],
    	...
    	card2 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: /*error*/ ctx[9][0],
    						itemClass: /*error*/ ctx[9][0].indexOf(/*airline*/ ctx[0]["IAR Error Management"]) > -1
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: /*error*/ ctx[9][1],
    						itemClass: /*error*/ ctx[9][1] === /*airline*/ ctx[0]["IAR Error Management"]
    						? "on apButton"
    						: "apButton"
    					}
    				],
    	...
    	card3 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: /*types*/ ctx[7][0],
    						itemClass: /*transaction*/ ctx[6].includes(/*types*/ ctx[7][0])
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: /*types*/ ctx[7][1],
    						itemClass: /*transaction*/ ctx[6].includes(/*types*/ ctx[7][1])
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: /*types*/ ctx[7][2],
    						itemClass: /*transaction*/ ctx[6].includes(/*types*/ ctx[7][2])
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: /*types*/ ctx[7][3],
    						itemClass: /*transaction*/ ctx[6].includes(/*types*/ ctx[7][3])
    						? "on apButton"
    						: "apButton"
    					}
    				],
    	...
    	card4 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: /*modifications*/ ctx[10][0],
    						itemClass: /*modifications*/ ctx[10][0] == /*airline*/ ctx[0]["IAR Modifications"]
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: /*modifications*/ ctx[10][1],
    						itemClass: /*modifications*/ ctx[10][1] == /*airline*/ ctx[0]["IAR Modifications"]
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: /*modifications*/ ctx[10][2],
    						itemClass: /*modifications*/ ctx[10][2] == /*airline*/ ctx[0]["IAR Modifications"]
    						? "on apButton"
    						: "apButton"
    					}
    				],
    	...
    	card5 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: /*payments*/ ctx[12][0],
    						itemClass: /*payments*/ ctx[12].includes(/*arcPayment*/ ctx[11][0])
    						? "ongreen apButton"
    						: "apButton"
    					},
    					{
    						item: /*payments*/ ctx[12][1],
    						itemClass: /*payments*/ ctx[12].includes(/*arcPayment*/ ctx[11][1])
    						? "ongreen apButton"
    						: "apButton"
    					}
    				],
    	...
    	card6 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: "Yes",
    						itemClass: "Yes" == /*airline*/ ctx[0]["Exchange & Refund Verification"]
    						? "ongreen apButton"
    						: "apButton"
    					},
    					{
    						item: "No",
    						itemClass: "No" == /*airline*/ ctx[0]["Exchange & Refund Verification"]
    						? "onred apButton"
    						: "apButton"
    					}
    				],
    	...
    	card7 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: "All",
    						itemClass: "All" == /*airline*/ ctx[0]["IAR Manual Entries"]
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: "None",
    						itemClass: "None" == /*airline*/ ctx[0]["IAR Manual Entries"]
    						? "on apButton"
    						: "apButton"
    					},
    					{
    						item: "Void",
    						itemClass: "Void" == /*airline*/ ctx[0]["IAR Manual Entries"]
    						? "on apButton"
    						: "apButton"
    					}
    				],
    ...
    function create_fragment$1(ctx) {
    	...
    	: /*airline*/ ctx[0]["Numeric Code"].toString().length == 1
    		? "00" + /*airline*/ ctx[0]["Numeric Code"]
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*airName2*/ ctx[4].length > 0 && create_if_block_1(ctx);

    	fa = new Fa({
    			props: {
    				icon: /*isOpen*/ ctx[2] ? faMinus : faPlus
    			},
    			$$inline: true
    		});

    	fa.$on("click", /*toggle*/ ctx[5]);
    	let if_block1 = /*isOpen*/ ctx[2] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "air-designator svelte-dafaow");
    			add_location(div0, file$1, 60, 16, 1838);
    			attr_dev(div1, "class", "air-code svelte-dafaow");
    			add_location(div1, file$1, 61, 16, 1909);
    			attr_dev(div2, "class", "d-flex align-items-center");
    			add_location(div2, file$1, 59, 14, 1782);
    			attr_dev(div3, "class", "air-name svelte-dafaow");
    			add_location(div3, file$1, 69, 14, 2277);
    			attr_dev(span, "class", "svelte-dafaow");
    			add_location(span, file$1, 78, 18, 2626);
    			attr_dev(div4, "class", "air-updated svelte-dafaow");
    			set_style(div4, "margin-right", "0px");
    			add_location(div4, file$1, 77, 16, 2555);
    			attr_dev(div5, "class", "ml-auto d-flex align-items-center");
    			add_location(div5, file$1, 76, 14, 2491);
    			attr_dev(div6, "class", "d-flex flex-column flex-lg-row");
    			add_location(div6, file$1, 58, 12, 1723);
    			attr_dev(div7, "class", "col-11");
    			add_location(div7, file$1, 57, 10, 1690);

    			attr_dev(div8, "class", div8_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2]
    			? "active open expand"
    			: "closed expand") + " svelte-dafaow"));

    			attr_dev(div8, "aria-expanded", /*isOpen*/ ctx[2]);
    			add_location(div8, file$1, 86, 12, 2871);
    			attr_dev(div9, "class", "col-1 svelte-dafaow");
    			add_location(div9, file$1, 84, 10, 2770);
    			...
    			add_location(div10, file$1, 52, 8, 1540);
    			attr_dev(div11, "class", "product-accordion-start svelte-dafaow");
    			add_location(div11, file$1, 51, 6, 1494);
    			attr_dev(div12, "class", "product-accordion-top svelte-dafaow");
    			add_location(div12, file$1, 50, 4, 1452);

    			attr_dev(div13, "class", div13_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2]
    			? "active airline-accordion product-accordion-row"
    			: "airline-accordion product-accordion-row") + " svelte-dafaow"));

    			add_location(div13, file$1, 45, 2, 1313);
    			attr_dev(a, "class", "accordion container svelte-dafaow");

    			attr_dev(a, "href", a_href_value = /*isOpen*/ ctx[2]
    			? "#" + /*airline*/ ctx[0]["Airline Name"].replace(" ", "") + "open?utm_source=ndc_airline"
    			: "#" + /*airline*/ ctx[0]["Airline Name"].replace(" ", "") + "closed?utm_source=ndc_airline");

    			add_location(a, file$1, 34, 0, 1044);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(fa, div8, null);
    			append_dev(div11, t11);
    			if (if_block1) if_block1.m(div11, null);
    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(a, "click", /*toggle*/ ctx[5], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*airName*/ 8) set_data_dev(t4, /*airName*/ ctx[3]);

    			if (/*airName2*/ ctx[4].length > 0) {
    				if (if_block0) {
    			...
    			if (!current || dirty & /*date*/ 2) set_data_dev(t9, /*date*/ ctx[1]);
    			const fa_changes = {};
    			if (dirty & /*isOpen*/ 4) fa_changes.icon = /*isOpen*/ ctx[2] ? faMinus : faPlus;
    			fa.$set(fa_changes);

    			if (!current || dirty & /*isOpen*/ 4 && div8_class_value !== (div8_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2]
    			? "active open expand"
    			: "closed expand") + " svelte-dafaow"))) {
    				attr_dev(div8, "class", div8_class_value);
    			}
    			...
    			if (!current || dirty & /*isOpen*/ 4 && div13_class_value !== (div13_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2]
    			? "active airline-accordion product-accordion-row"
    			: "airline-accordion product-accordion-row") + " svelte-dafaow"))) {
    				attr_dev(div13, "class", div13_class_value);
    			}

    			if (!current || dirty & /*isOpen, airline*/ 5 && a_href_value !== (a_href_value = /*isOpen*/ ctx[2]
    			? "#" + /*airline*/ ctx[0]["Airline Name"].replace(" ", "") + "open?utm_source=ndc_airline"
    			: "#" + /*airline*/ ctx[0]["Airline Name"].replace(" ", "") + "closed?utm_source=ndc_airline")) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('transaction' in $$props) $$invalidate(6, transaction = $$props.transaction);
    		if ('types' in $$props) $$invalidate(7, types = $$props.types);
    		if ('sfType' in $$props) $$invalidate(8, sfType = $$props.sfType);
    		if ('error' in $$props) $$invalidate(9, error = $$props.error);
    		if ('modifications' in $$props) $$invalidate(10, modifications = $$props.modifications);
    		if ('arcPayment' in $$props) $$invalidate(11, arcPayment = $$props.arcPayment);
    		if ('payments' in $$props) $$invalidate(12, payments = $$props.payments);
    		if ('airName' in $$props) $$invalidate(3, airName = $$props.airName);
    		if ('airName2' in $$props) $$invalidate(4, airName2 = $$props.airName2);
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		const file = await (await fetch("https://www2.arccorp.com/globalassets/homepage/redesign/ndc/airlines/ndc-airlines.xlsx")).arrayBuffer();

    		// parse the array by reading the file
    		const wb = readSync(file);

    		$$invalidate(1, date = wb.Props.ModifiedDate.toString().substring(4, 10) + ", " + wb.Props.ModifiedDate.toString().substring(11, 15));
