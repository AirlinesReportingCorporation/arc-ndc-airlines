    ...
    */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*airline, payments, arcPayment, modifications, types, transaction, error, sfType*/ 2033) {
    ...
    // (92:12) {#if a["Airline Name"].indexOf("Accelya") > -1}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(92:12) {#if a[\\\"Airline Name\\\"].indexOf(\\\"Accelya\\\") > -1}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(89:10) {#each airline as a}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let t2_value = (/*airline*/ ctx[0][0]["Numeric Code"].toString().length == 2
    	? "0" + /*airline*/ ctx[0][0]["Numeric Code"]
    	: /*airline*/ ctx[0][0]["Numeric Code"].toString().length == 1
    		? "00" + /*airline*/ ctx[0][0]["Numeric Code"]
    		: /*airline*/ ctx[0][0]["Numeric Code"]) + "";
    	...
    	fa = new Fa({
    			props: {
    				icon: /*isOpen*/ ctx[1] ? faMinus : faPlus
    			},
    			$$inline: true
    		});

    	fa.$on("click", /*toggle*/ ctx[3]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div5, file$1, 72, 14, 2399);
    			attr_dev(div6, "class", "d-flex flex-column flex-lg-row");
    			add_location(div6, file$1, 58, 12, 1743);
    			attr_dev(div7, "class", "col-11");
    			add_location(div7, file$1, 57, 10, 1710);
    			...
    			add_location(a, file$1, 34, 0, 1058);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*airline*/ 1) && t0_value !== (t0_value = /*airline*/ ctx[0][0].Designator + "")) set_data_dev(t0, t0_value);

    			if ((!current || dirty & /*airline*/ 1) && t2_value !== (t2_value = (/*airline*/ ctx[0][0]["Numeric Code"].toString().length == 2
    			? "0" + /*airline*/ ctx[0][0]["Numeric Code"]
    			: /*airline*/ ctx[0][0]["Numeric Code"].toString().length == 1
    				? "00" + /*airline*/ ctx[0][0]["Numeric Code"]
    				: /*airline*/ ctx[0][0]["Numeric Code"]) + "")) set_data_dev(t2, t2_value);

    			if (!current || dirty & /*airName*/ 4) set_data_dev(t4, /*airName*/ ctx[2]);
    			const fa_changes = {};
    			if (dirty & /*isOpen*/ 2) fa_changes.icon = /*isOpen*/ ctx[1] ? faMinus : faPlus;
    			fa.$set(fa_changes);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*date*/ 1) airline_1_changes.date = /*date*/ ctx[0];
    ...
    function create_fragment(ctx) {
    	...
    	let each_1_anchor;
    	let current;
    	let each_value = /*airlineCombined*/ ctx[1];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*airlineCombined, date*/ 3) {
    				each_value = /*airlineCombined*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		const file = await (await fetch("https://www2.arccorp.com/globalassets/products--participation/direct-connect/data.xlsx")).arrayBuffer();

    		// parse the array by reading the file
    		const wb = readSync(file);

    		$$invalidate(0, date = wb.Props.ModifiedDate.toString().substring(4, 10) + ", " + wb.Props.ModifiedDate.toString().substring(11, 15));
    	...
    	$$self.$inject_state = $$props => {
    		if ('airline' in $$props) airline = $$props.airline;
    		if ('airlineCombined' in $$props) $$invalidate(1, airlineCombined = $$props.airlineCombined);
