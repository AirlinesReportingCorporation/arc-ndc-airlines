    	...
    	card2 = new Card({
    			props: {
    				...
    				buttons: [
    					{
    						item: /*error*/ ctx[7][0],
    						itemClass: /*error*/ ctx[7][0].indexOf(/*airline*/ ctx[0]["IAR Error Management"]) > -1
    						? "on apButton"
    						: "apButton"
    					},
    					{
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			if (if_block) if_block.c();
    			attr_dev(div0, "class", "air-designator svelte-1tquqam");
    			add_location(div0, file$1, 40, 14, 1306);
    			attr_dev(div1, "class", "air-code svelte-1tquqam");
    			add_location(div1, file$1, 41, 14, 1375);
    			attr_dev(div2, "class", "d-flex align-items-center");
    			add_location(div2, file$1, 39, 12, 1252);
    			attr_dev(div3, "class", "air-name svelte-1tquqam");
    			add_location(div3, file$1, 47, 12, 1609);
    			attr_dev(span, "class", "svelte-1tquqam");
    			add_location(span, file$1, 50, 16, 1806);
    			attr_dev(div4, "class", "air-updated svelte-1tquqam");
    			set_style(div4, "margin-right", "0px");
    			add_location(div4, file$1, 49, 14, 1737);
    			attr_dev(div5, "class", "ml-auto d-flex align-items-center");
    			add_location(div5, file$1, 48, 12, 1675);
    			attr_dev(div6, "class", "d-flex flex-column flex-lg-row");
    			add_location(div6, file$1, 38, 10, 1195);
    			attr_dev(div7, "class", "col-11");
    			add_location(div7, file$1, 37, 8, 1164);

    			attr_dev(div8, "class", div8_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2]
    			? "active open expand"
    			: "closed expand") + " svelte-1tquqam"));

    			attr_dev(div8, "aria-expanded", /*isOpen*/ ctx[2]);
    			add_location(div8, file$1, 58, 10, 2035);
    			attr_dev(div9, "class", "col-1 svelte-1tquqam");
    			add_location(div9, file$1, 56, 8, 1938);
    			...
    			add_location(div10, file$1, 32, 6, 1024);
    			attr_dev(div11, "class", "product-accordion-start svelte-1tquqam");
    			add_location(div11, file$1, 31, 4, 980);
    			attr_dev(div12, "class", "product-accordion-top svelte-1tquqam");
    			add_location(div12, file$1, 30, 2, 940);

    			attr_dev(div13, "class", div13_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2]
    			? "active airline-accordion product-accordion-row"
    			: "airline-accordion product-accordion-row") + " svelte-1tquqam"));

    			add_location(div13, file$1, 25, 0, 811);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
