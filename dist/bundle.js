    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 46, 8, 1644);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = space();
    			if (if_block) if_block.c();
    			attr_dev(div0, "class", "air-designator svelte-1my70yq");
    			add_location(div0, file$1, 22, 14, 729);
    			attr_dev(div1, "class", "air-code svelte-1my70yq");
    			add_location(div1, file$1, 23, 14, 798);
    			attr_dev(div2, "class", "d-flex align-items-center");
    			add_location(div2, file$1, 21, 12, 675);
    			attr_dev(div3, "class", "air-name svelte-1my70yq");
    			add_location(div3, file$1, 29, 12, 1032);
    			attr_dev(span, "class", "svelte-1my70yq");
    			add_location(span, file$1, 32, 16, 1229);
    			attr_dev(div4, "class", "air-updated svelte-1my70yq");
    			set_style(div4, "margin-right", "0px");
    			add_location(div4, file$1, 31, 14, 1160);
    			attr_dev(div5, "class", "ml-auto d-flex align-items-center");
    			add_location(div5, file$1, 30, 12, 1098);
    			attr_dev(div6, "class", "d-flex flex-column flex-lg-row");
    			add_location(div6, file$1, 20, 10, 618);
    			attr_dev(div7, "class", "col-11");
    			add_location(div7, file$1, 19, 8, 587);
    			attr_dev(div8, "class", "expand svelte-1my70yq");
    			attr_dev(div8, "aria-expanded", /*isOpen*/ ctx[2]);
    			add_location(div8, file$1, 40, 10, 1458);
    			attr_dev(div9, "class", "col-1 svelte-1my70yq");
    			add_location(div9, file$1, 38, 8, 1361);
    			...
    			add_location(div10, file$1, 15, 6, 455);
    			attr_dev(div11, "class", "product-accordion-start svelte-1my70yq");
    			add_location(div11, file$1, 14, 4, 411);
    			attr_dev(div12, "class", "product-accordion-top svelte-1my70yq");
    			add_location(div12, file$1, 13, 2, 371);
    			attr_dev(div13, "class", "airline-accordion product-accordion svelte-1my70yq");
