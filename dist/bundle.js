...
var app = (function () {
    ...
    */
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div5, file$1, 30, 12, 1062);
    			attr_dev(div6, "class", "d-flex flex-column flex-lg-row");
    			add_location(div6, file$1, 20, 10, 575);
    		},
    		m: function mount(target, anchor) {
    ...
    // (39:8) <MDBCol size="1" style="max-width: 30px;">
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:8) <MDBCol size=\\\"1\\\" style=\\\"max-width: 30px;\\\">",
    		ctx
    	});
    ...
    // (16:6) <MDBRow         center         style="align-items: center; margin-left: -1.125rem; margin-right: -1.125rem;"       >
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(16:6) <MDBRow         center         style=\\\"align-items: center; margin-left: -1.125rem; margin-right: -1.125rem;\\\"       >",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 45, 8, 1579);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(mdbrow, div0, null);
    			append_dev(div0, t);
